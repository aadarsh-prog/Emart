...
public class AddItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtOPrice.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        txtCompany.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        txtQuantity.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        cbTax.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        cbTax.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0%", "5%", "10%", "15%", "20%" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbTax, 0, 159, Short.MAX_VALUE))
                .addGap(47, 47, 47))
        );
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       ...
       try
       {
           ...
           boolean status=ProductDAO.addItem(p);
           
           if(status)
           {
               BarCode_IMG_Generator.createImage(txtId.getText()+".png",txtId.getText());
    ...
    private void loadProductId() 
    {
        try
        {
        txtId.setText(getNextProductid());
        }
        catch(SQLException ex)
       {
            JOptionPane.showMessageDialog(null,"Database Error","Incomplete Data",JOptionPane.ERROR_MESSAGE);
